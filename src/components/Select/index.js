...
const Select = ({
  ...
  const changeValue = (newValue) => {
    onChange(newValue); // Ajout de la valeur newValue dans la fonction onChange pour pouvoir la récupérer dans le composant parent
    setValue(newValue);
    setCollapsed(true); // Fermeture de la liste déroulante après avoir sélectionné une valeur
  };
  return (
